...
import { parseEventResults } from "../parsers.js";
import type { EventSummary, SearchResult } from "../types.js";
...
): Promise<SearchResult<EventSummary>> {
  const params = new URLSearchParams();
  params.append("type", "mtneers.event");
